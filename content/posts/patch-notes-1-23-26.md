...
# {{< style word="-" type="red" >}}title removed{{< style word="words" type="light-grey" >}}
# {{< style word="+" type="green" >}}title added{{< style word="words" type="light-grey" >}}
# {{< style word="^" type="blue" >}}title promoted to all-time favorite{{< style word="words" type="light-grey" >}}
...
{{< style word="-" type="red" >}}warborne: above ashes {{< style word="lol. the best bad game i ever played. truly a moment in time i will remember forever. the pvp. the drama. i went to war those boys and i'm coming back stronger" type="light-grey" >}}

{{< style word="+" type="green" >}}dawn of war iv {{< style word="dawn of war 1 is my most played rts and the only one i actually went online to play against randos with. incredible game. dawn of war 2 was cool. dawn of war 3 was deedee megadoodoo." type="light-grey" >}}

{{< style word="-" type="red" >}}mechabreak {{< style word="super cool combat, the modes available just didn't end up being my thing, also i'm pretty sure the progression was ridiculous but i didn't get far enough to find out" type="light-grey" >}}

{{< style word="+" type="green" >}}league of legends {{< style word="mm watcha say? i'm playing a lot of aram. league of legends invented queue anxiety but you can't deny that it's a good pvp game" type="light-grey" >}}

{{< style word="+" type="green" >}}divinity {{< style word="hell yeah" type="light-grey" >}}

{{< style word="-" type="red" >}}repo {{< style word="i would still play this, i'm just not actively hoping for it to come up" type="light-grey" >}}

{{< style word="+" type="green" >}}twilight imperium digital {{< style word="really cool board game that's just too girthy to fit, now in digital form so you can stick it anywhere" type="light-grey" >}}
...
{{< style word="-" type="red" >}}digimon survive {{< style word="i'll probably still finish this game, maybe it'll get added to the all-time favorites. for now there's just nothing to be said about it" type="light-grey" >}}
