...
i've made a dumb website for my custom domain. {{< style word="hooray" type="yellow" >}}.

i registered the domain for e-mail but it might as well have a site on it too. i thought it would be {{< style word="cute" type="pink" >}} to curate a list of video games i'd like to play, which will mostly be strategy and board games that are too cumbersome and will never happen.  

i'll {{< style word="probably" type="strikethrough" >}} maybe blog about the games i'm playing sometimes? or other things? unlikely.
