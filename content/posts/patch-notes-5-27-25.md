...
{{< style word="^" type="blue" >}}titanfall 2 promoted to all-time favorite {{< style word="//i played the campaign and it was phenomenal, one of my biggest gaming regrets is not getting into the multiplayer" type="grey" >}}  

{{< style word="+" type="green" >}}hubworld: aidalon {{< style word="//new card game by earthborne games, greatly inspired by netrunner, two top tier statements right there" type="grey" >}}  

{{< style word="+" type="green" >}}warborne: above ashes {{< style word="//albion online meets planetside 2, yes yes yes yes yes" type="grey" >}}  

{{< style word="^" type="blue" >}}wreckfest promoted to all-time favorite and replaced with wreckfest 2  

{{< column >}}
{{< style word="2/28/25" type="yellow" >}}  

{{< style word="+" type="green" >}}digimon: survive {{< style word="//i just wanted to play a digimon game since i never have, and i'm more interested in the dark story and tactics gameplay" type="grey" >}}  

{{< style word="+" type="green" >}}wreckfest {{< style word="//this has actually been one of my faves for a long time now, i just forgot to put it on this list" type="grey" >}}  

{{< style word="+" type="green" >}}marvel rivals {{< style word="//friends were interested in playing, good game but i'm generally not interested in highly competitive games with small teams anymore. also i've just been kind of over marvel lately" type="grey" >}}  

{{< style word="+" type="green" >}}titanfall 2 {{< style word="//playing the campaign for this game has been a long-time-coming" type="grey" >}}  

{{< style word="+" type="green" >}}mecha break  

{{< style word="-" type="red" >}}solforge fusion  
{{< end-columns >}}  

{{< start-columns >}}
{{< style word="1/13/25" type="yellow" >}}   

{{< style word="-" type="red" >}}throne and liberty {{< style word="//such a disappointment but i'm glad i experienced it" type="grey" >}}  

{{< style word="-" type="red" >}}dark and darker  

{{< style word="+" type="green" >}}towerborne  

mario party superstars changed to mario party jamboree  

{{< style word="+" type="green" >}}light of motiram {{< style word="//monster hunter but you're murdering out-of-control robots instead of sentient creatures, sign me the hell up  " type="grey" >}}  

{{< style word="+" type="green" >}}caracoles {{< style word="//this isn't going to last a long time or anything but this game is so stylish and such a fun idea  " type="grey" >}}
{{< column >}}
{{< style word="11/12/24" type="yellow" >}}    

{{< style word="-" type="red" >}}stellaris nexus{{< style word="//a fresh title in the long list of multiplayer strategy games that i want to love but nobody plays " type="grey" >}}  

{{< style word="+" type="green" >}}the bazaar {{< style word="//forgot to add earlier, one of the very few games to ever launch whose quality met the amount amount of hype i had for it" type="grey" >}}  

{{< style word="+" type="green" >}}sovl fantasy warfare  

{{< style word="+" type="green" >}}dune awakening {{< style word="//i think they've exaggerated what this game will be, but i love it on paper" type="grey" >}}  
{{< end-columns >}}
